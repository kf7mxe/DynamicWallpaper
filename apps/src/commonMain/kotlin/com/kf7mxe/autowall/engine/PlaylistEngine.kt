...
object PlaylistEngine {
    ...
    fun executeAction(playlist: Playlist, action: PlaylistAction): Playlist = when (action) {
        ...
        is SwitchToSubPlaylistAction -> switchToSubPlaylist(playlist, action.subPlaylistName)
        is SpecificWallpaperAction -> goToSpecific(playlist, action.imageFileName)
    }
}
