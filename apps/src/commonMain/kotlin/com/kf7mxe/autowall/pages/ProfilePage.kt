...
import com.kf7mxe.autowall.engine.WallpaperActionRunner
import com.kf7mxe.autowall.engine.WallpaperTarget
import com.kf7mxe.autowall.engine.WallpaperTargetManager
import com.kf7mxe.autowall.engine.scheduleTriggers
import com.kf7mxe.autowall.name
import com.kf7mxe.autowall.sdk.*
import com.kf7mxe.autowall.storage.LocalPlaylistStore
import com.kf7mxe.autowall.storage.deletePlaylistImages
import com.kf7mxe.autowall.theming.DynamicThemeManager
import com.kf7mxe.autowall.theming.ThemeMode
import com.kf7mxe.autowall.theming.ThemeModeManager
...
//                                onClick { saveSelectedApi(option) }
            ...
            card.col {
                h3 { content = "About" }
                row {
                    expanding.text { content = "AutoWall" }
