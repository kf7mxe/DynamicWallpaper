...
import com.kf7mxe.autowall.ForecastUpdateInterval
import com.kf7mxe.autowall.TriggerByWeather
import com.kf7mxe.autowall.WeatherCondition
import com.kf7mxe.autowall.WeatherLocationType
            ...
            row {
                ...
                expanding.important.button {
                    ...
                    action = Action("Next") {
                        ...
                        val encoded = Json.encodeToString<com.kf7mxe.autowall.Trigger>(trigger)
